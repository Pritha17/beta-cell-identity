...
namespace LSODA_algo {
    ...
    vector<double> metblsm_par, int ros_signal, int insulin_signal);
    ...
    public:
        ...
        void lsoda_update(LSODA_ODE_SYSTEM_TYPE f, const size_t neq,
                          ...
                          double rtol, double atol, vector<double> metblsm_par, int ros_signal, int insulin_signal // Tolerance
                         );
