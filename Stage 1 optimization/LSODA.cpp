...
namespace LSODA_algo {
    ...
    */
    void LSODA::correction(const size_t neq, vector<double> &y,
                           ...
                           double *rh, size_t *m, vector<double> data)
    {
    ...
    */
                            ...
                            )
    {
        ...
        lsoda(f, neq, yout, t, tout, itask, istate, iopt, jt, iworks, rworks, data);
    }
}
